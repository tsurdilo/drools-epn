 ...
 * <ul>
 *   <li>{@link org.drools.epn.impl.EventConsumerImpl#getImplementation <em>Implementation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventConsumerImpl extends TaskImpl implements EventConsumer {
    ...
    public void setImplementation(Object newImplementation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EPNPackage.EVENT_CONSUMER__IMPLEMENTATION, oldImplementation, implementation, !oldImplementationESet));
    }
    ...
    public void unsetImplementation() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, EPNPackage.EVENT_CONSUMER__IMPLEMENTATION, oldImplementation, IMPLEMENTATION_EDEFAULT, oldImplementationESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case EPNPackage.EVENT_CONSUMER__IMPLEMENTATION:
