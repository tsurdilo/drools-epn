...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Event Consumer</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.drools.epn.impl.EventConsumerImpl#getDataOutputs <em>Data Outputs</em>}</li>
 *   <li>{@link org.drools.epn.impl.EventConsumerImpl#getDataInputs <em>Data Inputs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EventConsumerImpl extends TaskImpl implements EventConsumer {
    /**
    ...
    protected EClass eStaticClass() {
        return EpnPackage.Literals.EVENT_CONSUMER;
    }
        ...
        if (dataOutputs != null && dataOutputs.eIsProxy()) {
            ...
            if (dataOutputs != oldDataOutputs) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, EpnPackage.EVENT_CONSUMER__DATA_OUTPUTS, oldDataOutputs, dataOutputs));
            }
        }
        return dataOutputs;
    }
    ...
    public void setDataOutputs(DataOutput newDataOutputs) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EpnPackage.EVENT_CONSUMER__DATA_OUTPUTS, oldDataOutputs, dataOutputs));
    }
    ...
    public DataInput getDataInputs() {
        if (dataInputs != null && dataInputs.eIsProxy()) {
            ...
            if (dataInputs != oldDataInputs) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, EpnPackage.EVENT_CONSUMER__DATA_INPUTS, oldDataInputs, dataInputs));
            }
        }
        return dataInputs;
    }
    ...
    public void setDataInputs(DataInput newDataInputs) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EpnPackage.EVENT_CONSUMER__DATA_INPUTS, oldDataInputs, dataInputs));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case EpnPackage.EVENT_CONSUMER__DATA_OUTPUTS:
                if (resolve) return getDataOutputs();
                return basicGetDataOutputs();
            case EpnPackage.EVENT_CONSUMER__DATA_INPUTS:
