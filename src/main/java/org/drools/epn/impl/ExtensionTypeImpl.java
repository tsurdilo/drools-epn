 ...
 * <ul>
 *   <li>{@link org.drools.epn.impl.ExtensionTypeImpl#getAny <em>Any</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExtensionTypeImpl extends EObjectImpl implements ExtensionType {
    ...
    protected EClass eStaticClass() {
        return EPNPackage.Literals.EXTENSION_TYPE;
    }
    ...
    public FeatureMap getAny() {
        if (any == null) {
            any = new BasicFeatureMap(this, EPNPackage.EXTENSION_TYPE__ANY);
        }
        return any;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case EPNPackage.EXTENSION_TYPE__ANY:
