 ...
 * <ul>
 *   <li>{@link org.drools.epn.impl.CallableElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CallableElementImpl extends RootElementImpl implements CallableElement {
    ...
    protected EClass eStaticClass() {
        return EPNPackage.Literals.CALLABLE_ELEMENT;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EPNPackage.CALLABLE_ELEMENT__NAME, oldName, name));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case EPNPackage.CALLABLE_ELEMENT__NAME:
                return getName();
        }
