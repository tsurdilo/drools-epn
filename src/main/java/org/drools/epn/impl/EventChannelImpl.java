 ...
 * <ul>
 *   <li>{@link org.drools.epn.impl.EventChannelImpl#getImplementation <em>Implementation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventChannelImpl extends TaskImpl implements EventChannel {
    ...
    public void setImplementation(Object newImplementation) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EPNPackage.EVENT_CHANNEL__IMPLEMENTATION, oldImplementation, implementation, !oldImplementationESet));
    }
    ...
    public void unsetImplementation() {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.UNSET, EPNPackage.EVENT_CHANNEL__IMPLEMENTATION, oldImplementation, IMPLEMENTATION_EDEFAULT, oldImplementationESet));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case EPNPackage.EVENT_CHANNEL__IMPLEMENTATION:
