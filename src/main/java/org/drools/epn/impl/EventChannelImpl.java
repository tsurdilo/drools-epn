 ...
 * <ul>
 *   <li>{@link org.drools.epn.impl.EventChannelImpl#getDataOutputs <em>Data Outputs</em>}</li>
 *   <li>{@link org.drools.epn.impl.EventChannelImpl#getDataInputs <em>Data Inputs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EventChannelImpl extends TaskImpl implements EventChannel {
    /**
    ...
    protected EClass eStaticClass() {
        return EpnPackage.Literals.EVENT_CHANNEL;
    }
        ...
        if (dataOutputs != null && dataOutputs.eIsProxy()) {
            ...
            if (dataOutputs != oldDataOutputs) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, EpnPackage.EVENT_CHANNEL__DATA_OUTPUTS, oldDataOutputs, dataOutputs));
            }
        }
        return dataOutputs;
    }
    ...
    public void setDataOutputs(DataOutput newDataOutputs) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EpnPackage.EVENT_CHANNEL__DATA_OUTPUTS, oldDataOutputs, dataOutputs));
    }
    ...
    public DataInput getDataInputs() {
        if (dataInputs != null && dataInputs.eIsProxy()) {
            ...
            if (dataInputs != oldDataInputs) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, EpnPackage.EVENT_CHANNEL__DATA_INPUTS, oldDataInputs, dataInputs));
            }
        }
        return dataInputs;
    }
    ...
    public void setDataInputs(DataInput newDataInputs) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EpnPackage.EVENT_CHANNEL__DATA_INPUTS, oldDataInputs, dataInputs));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case EpnPackage.EVENT_CHANNEL__DATA_OUTPUTS:
                if (resolve) return getDataOutputs();
                return basicGetDataOutputs();
            case EpnPackage.EVENT_CHANNEL__DATA_INPUTS:
